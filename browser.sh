...
NEEDED_WINDOW_CLASS="Navigator.Firefox" #"crx_mpognobbkildjkofajifpdfhcoklimli.Vivaldi-snapshot"
LAUNCH_PROGRAM="kstart --desktop 3 /usr/bin/firefox -height 900 -width 1600"
